...
const buildTemplate = (id, school) => {
  ...
  const youtubeUrl = "https://www.youtube.com/watch?v=2j6rLLkFZOU&authuser=0";
...
Please view this link to my highlight video from the 2025 USA All-Star Championships in Madison, WI:
${youtubeUrl}
...
I have also attached my newly completed highlight video here for your review:
${youtubeUrl}
...
I am reaching out to share my updated highlight reel from my recent play with AZ Fear 17 and AZ High Performance. You can view the video here:
${youtubeUrl}
