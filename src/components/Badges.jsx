...
export const PriorityBadge = ({ priority }) => {
  const map = {
    Reach:  "bg-rose-50 text-cc-maroon border-rose-200",
    Target: "bg-sky-50 text-cc-light-blue border-sky-200",
    Safety: "bg-emerald-50 text-cc-forest border-emerald-200",
  };
...
export const NeedBadge = ({ need }) => {
  const map = {
    High: "bg-rose-50 text-cc-maroon",
    Med:  "bg-amber-50 text-cc-warning",
